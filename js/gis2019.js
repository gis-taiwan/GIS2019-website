            ...
            if (url == "item-1") {
                foldingContent.html(
                    '<div class="cd-fold-content single-page">' +
                        ...
                        "   <em>Sustainability for a better future</em>" +
                ...
                foldingContent.html(
                    '<div class="cd-fold-content single-page">' +
                        ...
                        "   <em>Welcome to the new older generation</em>" +
                ...
                foldingContent.html(
                    '<div class="cd-fold-content single-page">' +
                        ...
                        "   <em>Be ready for the next big opportunity</em>" +
                ...
                foldingContent.html(
                    '<div class="cd-fold-content single-page">' +
                        ...
                        "   <em>Embrace uncertainty and start to lead</em>" +
